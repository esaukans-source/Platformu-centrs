(function () {
  ...
  var I18N = {
    lv: {
      title: "Siltuma tames kalkulators",
      date: "Datums",
      project: "Projekts",
      mode: "Rezims",
      ...
      sectionSystem: "1) Sistemas kopsavilkums",
      totalPower: "Kopa jauda",
      source: "Avota ieteikums",
      radiatorFlow: "Radiatoru plusma",
      ufhFlow: "UFH plusma",
      ufhLoops: "UFH konturas",
      mixing: "Maisisanas mezgls",
      boiler: "Boileris",
      boilerRange: "Boilera diapazons",
      expansion: "Izplesanas tvertne",
      pipeNeed: "UFH caurule ar rezervi",
      pipeRolls: "Rullisi (200m)",
      pipeLeftover: "Prognozetais atlikums",
      sectionRooms: "2) Telpu rezultati",
      emitter: "emisija",
      emitterUfh: "UFH",
      ...
      materials: "Materiali",
      labor: "Darbs",
      overhead: "Pieskaitamas izmaksas",
      reserve: "Rezerve",
      total: "KOPA",
      note: "Piezime: Quick rezims ir orientejoss; Engineer precizitate atkariga no ievades datiem.",
      filename: "siltuma-tame.pdf",
      unitPcs: "gab",
      unitSet: "kompl",
      unitPack: "paka",
      mixingCompact: "Kompakts mezgls (lidz ~40m2, 2 konturas)",
      mixingStandard: "Standarta mezgls (kolektors + suknis + maisisana)",
      ...
      bomMixCompact: "Maisisanas mezgls (kompakts, lidz ~40m2)",
      bomMixStandard: "Maisisanas mezgls (standarta)",
      bomActuator: "Servopiedzina kolektoram",
      bomEdgeTape: "Malu lenta",
      bomInsulation: "Siltumizolacijas slanis UFH",
      bomClipPack: "UFH skavu paka (200 gab)",
      bomVaporBarrier: "Hidro/PE pleve UFH",
      bomRadiatorPrefix: "Radiators",
      bomValveSet: "Radiatora termovarsta komplekts",
      bomThermostat: "Telpas termostats",
      bomBalancing: "Noslegarmatura un balansesanas komplekts",
      bomAirVent: "Atgaisotajs + drenazas mezgls",
      bomFixing: "Stiprinajumi un montazas materiali",
      bomSourceConnection: "Avota piesleguma mezgls",
    },
    en: {
